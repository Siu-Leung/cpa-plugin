	...
	return registration{
		...
		Metadata: pluginapi.Metadata{
			...
			ConfigFields: []pluginapi.ConfigField{
				...
				{Name: "oauth_region", Type: pluginapi.ConfigFieldTypeEnum, EnumValues: []string{oauthRegionCN, oauthRegionGlobal}, Description: "Region used by the official CPA OAuth login entry: cn (copilot.tencent.com, default) or global (www.workbuddy.ai). Changing this does not affect existing accounts."},
